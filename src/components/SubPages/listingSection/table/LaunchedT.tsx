...
interface Props {
  ...
  const LaunchedT : NextPage<Props> = (props:Props) => {
    ...
    <>
        <Box sx={{direction:"row", display:"flex", justifyContent:"space-between", overflowY:'initial', overflowX: 'auto'}}>
          ...
          <Box>
            ...
            <Box>
              <Select defaultValue="1" className={classes.selectOption}>
                <MenuItem value="1" className={classes.menuItemStyle}>All</MenuItem>
          ...
          <Box>
              ...
              <Box className={classes.tableheader}>
                ...
                <Stack direction="row">
                  <Box className={classes.customCardView}>
                    <Typography sx={{fontSize:'12px', fontWeight:'bold', mt:1}}>Holders</Typography>
                  </Box>
                  ...
                  <Box className={classes.customCardView}>
                    <Typography sx={{fontSize:'12px', fontWeight:'bold', mt:1}}>MarketCap</Typography>
                  </Box>
            ...
            {listingData&&listingData.length>0&&listingData.filter((item:any, index)=>((index < 10))).map((item:any, index:any) => {
            return (
                <Box key={index} className={classes.customBoxStyle} sx={{background: 'rgba(27, 29, 51, 0.5)'}}>
                      ...
                      <Stack direction="row">
                        <Box className={classes.customCardView}>
                        <Typography sx={{color:'#54FEA2', fontSize:'12px', fontWeight:'bold', mt:1}}>X,xxx</Typography>
                        </Box>
                        ...
                        <Box className={classes.customCardView}>
                          <Typography sx={{color:'#54FEA2', fontSize:'12px', mt:1}}>X,xx</Typography>
                        </Box>
